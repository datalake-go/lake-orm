module github.com/datalake-go/lake-orm
...
require (
	...
	github.com/datalake-go/spark-connect-go v0.0.0-00010101000000-000000000000
...
// Local-dev convenience: point at a sibling checkout of the fork so
// in-progress changes in github.com/datalake-go/spark-connect-go are
// picked up without a push+tidy cycle. Drop this once the fork cuts
// stable tagged releases.
replace github.com/datalake-go/spark-connect-go => ../spark-connect-go
